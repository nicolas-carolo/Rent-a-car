...
INSERT INTO cars(brand, model, car_year, plate, n_seats, car_type, min_age, engine, fuel, power, transmission, photo_link, price, preview) VALUES ('Volkswagen', 'Tiguan', 2017, 'FN342BF', 5, 'SUV', 25, '2.0', 'Diesel', 150, 'Automatic', '/static/media/cars/vw-tiguan.jpg', 70, true);
INSERT INTO cars(brand, model, car_year, plate, n_seats, car_type, min_age, engine, fuel, power, transmission, photo_link, price, preview) VALUES ('Peugeot', '3008', 2018, 'FP729HF', 5, 'SUV', 25, '2.0', 'Diesel', 150, 'Automatic', '/static/media/cars/peugeot-3008.jpg', 60, true);
...
INSERT INTO cars(brand, model, car_year, plate, n_seats, car_type, min_age, engine, fuel, power, transmission, photo_link, price, preview) VALUES ('Fiat', 'Panda', 2013, 'ER453HS', 4, 'City Car', 18, '1.2', 'Gasoline', 69, 'Manual', '/static/media/cars/fiat-panda.jpg', 28, true);
INSERT INTO cars(brand, model, car_year, plate, n_seats, car_type, min_age, engine, fuel, power, transmission, photo_link, price, preview) VALUES ('Lancia', 'Ypsilon', 2015, 'FA749LF', 4, 'City Car', 18, '1.2', 'Gasoline', 69, 'Manual', '/static/media/cars/lancia-y.jpg', 30, true);
